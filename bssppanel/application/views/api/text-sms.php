    ...
    <div class="row">
        <ul class="nav nav-pills">
            <li class="<?php echo (isset($page_type) && $page_type && $page_type == 1) ? "active" : ""; ?>">
                <a href="<?php echo base_url(); ?>api_docs/send_sms_api">Send SMS</a>
            </li>
            <li class="<?php echo (isset($page_type) && $page_type && $page_type == 2) ? "active" : ""; ?>">
                <a href="<?php echo base_url(); ?>api_docs/xml_send_sms_api">XML Send SMS</a>
            </li>
            <li class="<?php echo (isset($page_type) && $page_type && $page_type == 3) ? "active" : ""; ?>">
                <a href="<?php echo base_url(); ?>api_docs/delivery_report_api">Delivery Report</a>
            </li>
            ...
            <div class="row">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-3 bhoechie-tab-menu">
                                <div class="list-group">
                                    <a href="#" class="list-group-item active text-center">
                                        <h4 class="fa fa-gears"></h4><br/>Send SMS
                                    </a>
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9 bhoechie-tab">
                                <div class="portlet">
                                    ...
                                    <div class="bhoechie-tab-content active">
                                        ...
                                        <h4>Note -</h4>
                                        <p class="text-danger">If you submit large number of request, always use XML API for better performance</p>
                                        <h4>Sample API -</h4>
                                        <h4>Modern API</h4>
                                        <p class="text-success"><?php echo (isset($domain_name) && $domain_name) ? $domain_name : ""; ?>api/send_http.php?<mark>authkey</mark>=YourAuthKey&<mark>mobiles</mark>=9999999991&<mark>message</mark>=Hello Worlds&<mark>sender</mark>=SenderID&<mark>route</mark>=A</p>
                                        <h5>OR</h5>
                                        <h4>Traditional API</h4>
                                        <p class="text-success"><?php echo (isset($domain_name) && $domain_name) ? $domain_name : ""; ?>api/send_http.php?<mark>username</mark>=username&<mark>password</mark>=password&<mark>mobiles</mark>=9999999991&<mark>message</mark>=Hello Worlds&<mark>sender</mark>=SenderID&<mark>route</mark>=A</p>
                                                ...
                                                <table class="table table-striped table-bordered bgf">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>varchar</td>
                                                            <td>Receiver will see this as sender's ID</td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>If your operator supports multiple routes then give one route name.<br/>
                                                                ...
                                                                For Stock Promotion route=<strong>C</strong> | <strong>2</strong> | <strong>Stock</strong><br/>
                                                                For Premium Promotion route=<strong>D</strong> | <strong>3</strong> | <strong>Premium</strong><br/>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>flash</td>
                                                        ...
                                                        <tr>
                                                            <td>ignoreNdnc</td>
                                                            <td>1</td>
                                                            <td>ignoreNdnc=1 (if you want system to ignore all NDNC Numbers)</td>
                                                        </tr>
                                                        <tr>
                                                            <td>schtime</td>
                                                            <td>Date and time</td>
                                        ...
                                        <h4>Sample Output - <span class="text-primary">5134842646923e183d000075</span></h4>
                                        <h4>Note -</h4>
                                        <p class="text-danger">Output will be request Id which is alphanumeric and contains 24 character like mentioned above. With this request Id, delivery Report can be Viewed. If Request not Sent Successfully, you will get the appropriate Error Message. </p>
                                    </div>
                                    ...
                                    <div class="bhoechie-tab-content">
                                        ...
                                        <h4>Example -</h4>
                                        <p class="text-success"><?php echo (isset($domain_name) && $domain_name) ? $domain_name : ""; ?>api/send_http.php?<mark>authkey</mark>=YourAuthKey&<mark>mobiles</mark>=9999999991&<mark>message</mark>=Hello Worlds&<mark>sender</mark>=SenderID&<mark>route</mark>=A</p>
                                        <h5>In this api the message content "test & new" includes '&' operator,due to which url encoding is necessary, otherwise it will break your message content and an incomplete message will be sent
                                        </h5>
                                        <h4>Encoded API -</h4>
                                        <p class="text-success"><?php echo (isset($domain_name) && $domain_name) ? $domain_name : ""; ?>api/send_http.php?<mark>authkey</mark>=YourAuthKey&<mark>mobiles</mark>=<?php echo urlencode('9999999991'); ?>&<mark>message</mark>=<?php echo urlencode('Hello Worlds'); ?>/<mark>sender</mark>=SenderID&<mark>route</mark>=A</p>
                                        <h5>By encoding message content in api,complete message will be sent</h5>
                                        <h4>For New Line Character in SMS use this below characters -</h4>
                                        <p class="text-success">%0D%0A</p>
                                        <h4>Or</h4>
                                        <p class="text-success">%0A</p>
                                    </div>

                                    <div class="bhoechie-tab-content">
                                        <h2 class="content-header-title">Send message on multiple numbers</h2>
                                        <h4>Example -</h4>
                                        <p class="text-success"><?php echo (isset($domain_name) && $domain_name) ? $domain_name : ""; ?>api/send_http.php?<mark>authkey</mark>=YourAuthKey&<mark>mobiles</mark>=9999999991,9999999992&<mark>message</mark>=<?php echo urlencode('Hello Worlds'); ?>&<mark>sender</mark>=SenderID&<mark>route</mark>=A</p>
                                        <h5>To send message on multiple numbers numbers should be comma separated</h5>
                                        <h2 class="content-header-title tbl">Send Flash SMS -</h2>
                                        <h4>Example -</h4>
                                        <p class="text-success"><?php echo (isset($domain_name) && $domain_name) ? $domain_name : ""; ?>api/send_http.php?<mark>authkey</mark>=YourAuthKey&<mark>mobiles</mark>=9999999991&<mark>message</mark>=Hello Worlds&<mark>sender</mark>=SenderID&<mark>route</mark>=A&<mark>flash</mark>=1</p>
                                        <h5>To send Flash message one more parameter will be added i.e flash and it's value will be set to 1</h5>
                                    </div>

                                    <div class="bhoechie-tab-content">
                                        <h2 class="content-header-title">Send Schedule message</h2>
                                        <h4>Example -</h4>
                                        <p class="text-success"><?php echo (isset($domain_name) && $domain_name) ? $domain_name : ""; ?>api/send_http.php?<mark>authkey</mark>=YourAuthKey&<mark>mobiles</mark>=9999999991&<mark>message</mark>=Hello Worlds&<mark>sender</mark>=SenderID&<mark>route</mark>=A&<mark>schtime</mark>=2015-03-19 15:01:26</p>
                                        <h5>To schedule message i.e for future , one parameter will be added i.e schtime and it's value should be equal to that date and time,at which message should be sent.</h5>
                                        <h4>Note -</h4>
                                        <p class="text-danger">for Scheduling, date and time are mandatory.</p>
                                        <h2 class="content-header-title tbl">JSON response -</h2>
                                        <h4>Example -</h4>
                                        <p class="text-success"><?php echo (isset($domain_name) && $domain_name) ? $domain_name : ""; ?>api/send_http.php?<mark>authkey</mark>=YourAuthKey&<mark>mobiles</mark>=9999999991&<mark>message</mark>=Hello Worlds&<mark>sender</mark>=SenderID&<mark>route</mark>=A&<mark>response</mark>=json</p>
                                        <h5>To get response in json format one more parameter will be added i.e response and it's value will be set to json</h5>
                                    </div>
                                    <div class="bhoechie-tab-content">
                                        <h2 class="content-header-title">Send unicode message</h2>
                                        <h4>Example -</h4>
                                        <p class="text-success"><?php echo (isset($domain_name) && $domain_name) ? $domain_name : ""; ?>api/send_http.php?<mark>authkey</mark>=YourAuthKey&<mark>mobiles</mark>=9999999991&<mark>message</mark>=Hello Worlds&<mark>sender</mark>=SenderID&<mark>route</mark>=A&<mark>unicode</mark>=1</p>
                                        <h5>To send Unicode message one more parameter will be added i.e unicode and it's value will be set to 1</h5>
                                    </div>
                                    <div class="bhoechie-tab-content">
                                        <h2 class="content-header-title">Schedule unicode message</h2>
                                        <h4>Example -</h4>
                ...
                <div class="col-md-3">
                    <div class="portlet">
                        ...
                        <div class="portlet-content">
                            <form role="form" class="validate" method='post' id="form41" action="javascript:generateAPI('4', '1', 'send_http');">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 form-group padding0">
                                        <label>Flash</label>
                                        <input id="flash" name="flash" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 form-group padding0">
                                        <label>Unicode</label>
                                        <input id="unicode" name="unicode" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 form-group padding0">
                                        <label>Schedule Time</label>
                                        <input id="schdate" name="schdate" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 form-group padding0">
        ...
        if (isset($page_type) && $page_type && $page_type == 2) {
            ...
            <div class="row">
                ...
                <span class="mw-code operator">&lt;</span><span class="mw-code operator">/</span>MESSAGE&gt;
                                        ...
                                        <h4>Sample Output - <span class="text-primary">5134842646923e183d000075</span></h4>
                                        <h4>Note -</h4>
                                        <p class="text-danger">Output will be request Id which is alphanumeric and contains 24 character like mentioned above. With this request Id, delivery Report can be Viewed. If Request not Sent Sucessfully, you will get the appropriate Error Message</p>
                                    </div>

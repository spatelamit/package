<div class="row">
    <div class="col-md-5 col-sm-12 col-xs-12 padding0">
        <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
            <h4>Main Files (Single Configuration)</h4>
            <table class="table">
                <tbody>
                    <?php
                    ...
                    if (isset($config_files) && sizeof($config_files)) {
                        ...
                        if (in_array('KannelC/Config/sendsms_user.conf', $config_files)) {
                            unset($config_files[array_search('KannelC/Config/sendsms_user.conf', $config_files)]);
                        }
                        if (in_array('KannelC/Config/smsbox_route.conf', $config_files)) {
                            unset($config_files[array_search('KannelC/Config/smsbox_route.conf', $config_files)]);
                        }
                        if (in_array('KannelC/Config/smsc.conf', $config_files)) {
                            unset($config_files[array_search('KannelC/Config/smsc.conf', $config_files)]);
                        }
                        ...
                        if (in_array('KannelC/Config/fake_smsc.conf', $config_files)) {
                            unset($config_files[array_search('KannelC/Config/fake_smsc.conf', $config_files)]);
                        }
                        foreach ($config_files as $key => $value) {
                            ...
                            <tr>
                                <td class="col-md-8">
                                    <a href="#" data-toggle="modal" data-target="#main<?php echo $key; ?>"><?php echo $remain; ?></a>
                                    <!-- Modal -->
                                    <div class="modal fade" id="main<?php echo $key; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
                                                            <table class="table table-bordered">
                                                                <tbody>
                                                                    <?php
                                                                    $conf = new ConfigTool();
                                                                    if (file_exists("KannelC/Config/" . $remain) && filesize('KannelC/Config/' . $remain)) {
                                                                        if ($conf->setConfigFromFile("KannelC/Config/" . $remain)) {
                                                                            if ($conf && sizeof($conf)) {
                                ...
                                <td class="col-md-2 text-right">
                                    ...
                                    if ($remain == 'core.conf') {
                                        ?>
                                        <a href="<?php echo base_url(); ?>kannel_control/update/core/<?php echo $remain; ?>" class="btn btn-primary btn-xs">
                                            Update
                                        </a>
                                        <?php
                                    }
                                    if ($remain == 'db_connection.conf') {
                                        ?>
                                        <a href="<?php echo base_url(); ?>kannel_control/update/db_connection/<?php echo $remain; ?>" class="btn btn-primary btn-xs">Update</a>
                                        <?php
                                    }
                                    if ($remain == 'dlr_db.conf') {
                                        ?>
                                        <a href="<?php echo base_url(); ?>kannel_control/update/dlr_db/<?php echo $remain; ?>" class="btn btn-primary btn-xs">Update</a>
                                        <?php
                                    }
                                    if ($remain == 'sms_service.conf') {
                                        ?>
                                        <a href="<?php echo base_url(); ?>kannel_control/update/sms_service/<?php echo $remain; ?>" class="btn btn-primary btn-xs">Update</a>
                                        <?php
                                    }
                                    if ($remain == 'smsbox.conf') {
                                        ?>
                                        <a href="<?php echo base_url(); ?>kannel_control/update/smsbox/<?php echo $remain; ?>" class="btn btn-primary btn-xs">Update</a>
                                        <?php
                                    }
                                    ?>
                                </td>
                                <td class="col-md-2 text-right">
                                    <a href="<?php echo base_url(); ?>kannel_control/delete/main/<?php echo $remain; ?>" class="btn btn-danger btn-xs">
                                        Delete
                                    </a>
                                </td>
                            </tr>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
            <h4>SQLBox Files (Single Configuration)</h4>
            <table class="table">
                <tbody>
                    <?php
                    ...
                    if (isset($sqlbox_files) && sizeof($sqlbox_files)) {
                        ...
                        foreach ($sqlbox_files as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td class="col-md-2 text-right">
                                    <?php
                                    if ($remain == 'sqlbox.conf') {
                                        ?>
                                        <a href="<?php echo base_url(); ?>kannel_control/update/sqlbox/<?php echo $remain; ?>" class="btn btn-primary btn-xs">Update</a>
                                        <?php
                                    }
                                    if ($remain == 'sql_connection.conf') {
                                        ?>
                                        <a href="<?php echo base_url(); ?>kannel_control/update/sqlbox/<?php echo $remain; ?>" class="btn btn-primary btn-xs">Update</a>
                                        <?php
                                    }
                                ...
                                <td class="col-md-2 text-right">
                                    <a href="<?php echo base_url(); ?>kannel_control/delete/sqlbox/<?php echo $remain; ?>" class="btn btn-danger btn-xs">
                                        Delete
                                    </a>
                                </td>
                            </tr>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
            <h4>SMSBox Route Files (Multiple Configuration)</h4>
            <table class="table">
                <tbody>
                    <?php
                    ...
                    if (isset($smsbox_route_files) && sizeof($smsbox_route_files)) {
                        foreach ($smsbox_route_files as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td class="col-md-2 text-right">
                                    <a href="<?php echo base_url(); ?>kannel_control/update/smsbox_route/<?php echo $remain; ?>" class="btn btn-primary btn-xs">Update</a>
                                </td>
                                <td class="col-md-2 text-right">
                                    <a href="<?php echo base_url(); ?>kannel_control/delete/smsbox_route/<?php echo $remain; ?>" class="btn btn-danger btn-xs">
                                        Delete
                                    </a>
                                </td>
                            </tr>
    ...
    <div class="col-md-5 col-sm-12 col-xs-12 padding0">
        <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
            <h4>SendSMS User Files (Multiple Configuration)</h4>
            <table class="table">
                <tbody>
                    <?php
                    ...
                    if (isset($sendsms_user_files) && sizeof($sendsms_user_files)) {
                        foreach ($sendsms_user_files as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td class="col-md-2 text-right">
                                    <a href="<?php echo base_url(); ?>kannel_control/update/sendsms_user/<?php echo $remain; ?>" class="btn btn-primary btn-xs">Update</a>
                                </td>
                                <td class="col-md-2 text-right">
                                    <a href="<?php echo base_url(); ?>kannel_control/delete/sendsms_user/<?php echo $remain; ?>" class="btn btn-danger btn-xs">
                                        Delete
                                    </a>
                                </td>
                            </tr>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
            <h4>SMSC Files (Multiple Configuration)</h4>
            <table class="table">
                <tbody>
                    <tr>
                        <th class="col-md-12" colspan="3">
                    ...
                    if (isset($smsc_files) && sizeof($smsc_files)) {
                        ...
                        foreach ($smsc_files as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td class="col-md-2 text-right">
                                    <a href="<?php echo base_url(); ?>kannel_control/update/smsc_trx/<?php echo $remain; ?>" class="btn btn-primary btn-xs">Update</a>
                                </td>
                                <td class="col-md-2 text-right">
                                    <a href="<?php echo base_url(); ?>kannel_control/delete/smsc_trx/<?php echo $remain; ?>" class="btn btn-danger btn-xs">
                                        Delete
                                    </a>
                                </td>
                            </tr>
                    ...
                    if (isset($smsc_files) && sizeof($smsc_files)) {
                        ...
                        foreach ($smsc_files as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td class="col-md-2 text-right">
                                    <a href="<?php echo base_url(); ?>kannel_control/update/smsc_tx/<?php echo $remain; ?>" class="btn btn-primary btn-xs">Update</a>
                                </td>
                                <td class="col-md-2 text-right">
                                    <a href="<?php echo base_url(); ?>kannel_control/delete/smsc_tx/<?php echo $remain; ?>" class="btn btn-danger btn-xs">
                                        Delete
                                    </a>
                                </td>
                            </tr>
                    ...
                    if (isset($smsc_files) && sizeof($smsc_files)) {
                        ...
                        foreach ($smsc_files as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td class="col-md-2 text-right">
                                    <a href="<?php echo base_url(); ?>kannel_control/update/smsc_rx/<?php echo $remain; ?>" class="btn btn-primary btn-xs">Update</a>
                                </td>
                                <td class="col-md-2 text-right">
                                    <a href="<?php echo base_url(); ?>kannel_control/delete/smsc_rx/<?php echo $remain; ?>" class="btn btn-danger btn-xs">
                                        Delete
                                    </a>
                                </td>
                            </tr>
                    ...
                    if (isset($fake_smsc_files) && sizeof($fake_smsc_files)) {
                        ...
                        foreach ($fake_smsc_files as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td class="col-md-2 text-right">
                                    <a href="<?php echo base_url(); ?>kannel_control/update/fake_smsc/<?php echo $remain; ?>" class="btn btn-primary btn-xs">Update</a>
                                </td>
                                <td class="col-md-2 text-right">
                                    <a href="<?php echo base_url(); ?>kannel_control/delete/fake_smsc/<?php echo $remain; ?>" class="btn btn-danger btn-xs">
                                        Delete
                                    </a>
                                </td>
                            </tr>

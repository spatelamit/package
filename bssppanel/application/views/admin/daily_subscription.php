...
<div class="page-content-title txt-center">
    ...
    <h3><i class="icon-chevron-sign-up"></i><i class="fa fa-sign-in" aria-hidden="true"></i> Daily Subscription</h3> 
 ...
 <div class="page-content-title txt-center">
    ...
    <div class="col-md-3">
     ...
     <div class="col-md-3">
     <a class="btn-primary" href="<?php echo base_url(); ?>admin/subscribe_mailer" target="_blank" ><input style="background-color: royalblue ;color: white ;border: 0; font-weight: bold ; height: 25px;width: 90px;" type="submit"  name="submit" value="Mailer"/></a>
     &nbsp&nbsp &nbsp
      <a class="btn-primary" href="<?php echo base_url(); ?>admin/subscribe_sms" target="_blank" ><input style="background-color: royalblue ;color: white ;border: 0; font-weight: bold ; height: 25px;width: 90px;" type="submit"  name="submit" value="Send Sms"/></a>
    </div>
                        ...
                        <tr>
                            ...
                            if (isset($subscribe_data) && $subscribe_data) {
                                ...
                                foreach ($subscribe_data as $subscribe_data_row) {
									...
									<td style="text-align: center"><?php echo $subscribe_data_row['subscribe_name']; ?></td>
                                    <td style="text-align: center"><?php echo $subscribe_data_row['subscribe_mobile']; ?></td>
                                    <td style="text-align: center"><?php echo $subscribe_data_row['subscribe_email']; ?></td>
                                    <td style="text-align: center"><?php echo $subscribe_data_row['subscribe_type']; ?></td>
                                    <td style="text-align: center"><?php echo $subscribe_data_row['subscribe_date']; ?></td>
                                   <td style="text-align: center"><?php echo $subscribe_data_row['ip_address']; ?></td>
                            <form method="post" action="<?php echo base_url(); ?>admin/update_subscription_feedback"> 
                                ...
                                <td >
                                    ...
                                    <input type="hidden"  name="subscribe_id" value="<?php echo $subscribe_data_row['subscribe_id']; ?>"/>

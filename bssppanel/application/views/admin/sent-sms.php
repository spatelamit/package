...
<div id="custom-sms">
    ...
    <div class="col-md-12 padding15">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($sms['status'] == "1" || $sms['status'] == "PROCESSED" || $sms['status'] == 'ANSWERED_MACHINE') {
                                            echo "Delivered";
                                            //$total_delivered+=1;
                                        } elseif ($sms['status'] == "2"  || $sms['status'] == "ERROR" || $sms['status'] == 'ERROR_NO_ANSWER') {
                                            echo "Failed";
                                            //$total_failed+=1;
                                    ...
                                    <td>
                                        <a href="#" data-container="body" data-toggle="popover" data-placement="left" data-html='true' data-trigger='click'
                                           data-content="<label>Default: </label><?php echo $sms['default_route']; ?>
                                           <br/>
                                           <label>Actual: </label>
                                           <?php echo $sms['actual_route']; ?>">
                                            Details
                                        </a>
                                    </td>
                                </tr>
        ...
        <div  class="btn btn-primary" style="  margin-top: -100px; margin-left: 470px;">
            
            
            <a  href="<?php echo base_url()."admin/update_push_dlr/". $sms['campaign_id'] . "/" . $sms['route'] ; ?>" style="color: white;" >Push DLR</a>
    </div>

...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-11">
  <form  method="post" action="<?php echo base_url(); ?>process/check_mail_user" autocomplete="off">
...
+918982-805000 " required="" type="button" class="btn btn-primary mybtn " data-toggle="modal" data-target="#myModal">&nbsp<span ><b>Website Change Template</b></span>&nbsp&nbsp&nbsp
   ...
   <div class="modal fade" id="myModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <center>  <span class="modal-title">Website Change Template</span></center>

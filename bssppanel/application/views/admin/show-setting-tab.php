...
<ul class="nav nav-tabs" role="tablist">
    ...
    if (isset($atype) || $atype == 1) {
        ...
        <li class="<?php echo (isset($subtab) && $subtab == "1") ? 'active"' : '' ?>">
         ...
         <li class="<?php echo (isset($subtab) && $subtab == "12") ? 'active"' : '' ?>">
            <a href="javascript:void(0)" onclick="getSettingTab('12');">Default Ratio</a>
        </li>
    ...
    <li class="<?php echo (isset($subtab) && $subtab == "11") ? 'active"' : '' ?>">
        <a href="javascript:void(0)" onclick="getSettingTab('11');">Add Alert</a>
    </li>
...
<div class="tab-content bgf9">
    <div class="tab-pane fade in active ">
        ...
        <?php if (isset($subtab) && $subtab == '1') { ?>
            <div class="row">                       
                <form role="form" class="setting_forms tab-forms" id="settingForm<?php echo $subtab; ?>1" method='post' action="javascript:saveSetting(<?php echo $subtab; ?>, 1);">
                    <div class="col-md-4 padding0">
                        <label><strong>Text SMS</strong></label>
                        <div class="form-group">
                            <label for="pr_balance">Promotional SMS</label>
                            <input type="text" class="form-control" value="<?php echo (isset($total_pr_balance) && $total_pr_balance) ? $total_pr_balance : "0"; ?>" 
                                   name="pr_balance" id="pr_balance" 
                        ...
                        <div class="form-group">
                            <label for="tr_balance">Transactional SMS</label>
                            <input type="text" class="form-control" value="<?php echo (isset($total_tr_balance) && $total_tr_balance) ? $total_tr_balance : "0"; ?>"
                                   name="tr_balance" id="tr_balance" 
                                   placeholder="Transactional SMS Balance" data-parsley-required-message="Please Enter SMS" data-parsley-type="digits" 
                                   required="" data-parsley-type-message="SMS must be a number" data-parsley-min="1"
                                   data-parsley-min-message="SMS must be greater than 0" />
                        </div>
                        <div class="form-group">
                            <label for="pr_to_dnd_balance">Premium SMS</label>
                            <input type="text" class="form-control" value="<?php echo (isset($prtodnd_balance) && $prtodnd_balance) ? $prtodnd_balance : "0"; ?>"
                                   name="new_prtodnd_balance" id="pr_to_dnd_balance" 
                                   placeholder="PR TO DND SMS Balance" data-parsley-required-message="Please Enter SMS" data-parsley-type="digits" 
                                   required="" data-parsley-type-message="SMS must be a number" data-parsley-min="1"
                                   data-parsley-min-message="SMS must be greater than 0" />
                        </div>
                        <div class="form-group">
                            <label for="stock_balance">STOCK SMS</label>
                            <input type="text" class="form-control" value="<?php echo (isset($stock_balance) && $stock_balance) ? $stock_balance : "0"; ?>"
                                   name="new_stock_balance" id="stock_balance" 
                                   placeholder="stock SMS Balance" data-parsley-required-message="Please Enter SMS" data-parsley-type="digits" 
                                   required="" data-parsley-type-message="SMS must be a number" data-parsley-min="1"
                                   data-parsley-min-message="SMS must be greater than 0" />
                        </div>
                          <div class="form-group">
                            <label for="international_sms">International SMS</label>
                            <input type="text" class="form-control" value="<?php echo (isset($international_sms) && $international_sms) ? $international_sms : "0"; ?>"
                                   name="international_sms" id="international_sms" 
                                   placeholder="stock SMS Balance" data-parsley-required-message="Please Enter SMS" data-parsley-type="digits" 
                                   required="" data-parsley-type-message="SMS must be a number" data-parsley-min="1"
                                   data-parsley-min-message="SMS must be greater than 0" />
                        </div>
                    ...
                    <div class="col-md-4 padding0">
                        <label><strong>Virtual Numbers</strong></label>
                        <div class="form-group">
                            <label for="long_balance">Long Code</label>
                            <input type="text" class="form-control" value="<?php echo (isset($total_lcode_balance) && $total_lcode_balance) ? $total_lcode_balance : "0"; ?>" 
                                   name="long_balance" id="long_balance" 
                                   placeholder="Long Code Balance" data-parsley-required-message="Please Enter SMS" data-parsley-type="digits" 
                                   required="" data-parsley-type-message="SMS must be a number" data-parsley-min="1"
                                   data-parsley-min-message="SMS must be greater than 0" />
                        </div>
                        <div class="form-group">
                            <label for="short_balance">Short Code</label>
                            <input type="text" class="form-control" value="<?php echo (isset($total_scode_balance) && $total_scode_balance) ? $total_scode_balance : "0"; ?>" 
                                   name="short_balance" id="short_balance" 
                    ...
                    <div class="col-md-4 padding0">
                        ...
                        <div class="form-group">
                            <label for="vpr_balance">Voice Promotional</label>
                            <input type="text" class="form-control" value="<?php echo (isset($total_vpr_balance) && $total_vpr_balance) ? $total_vpr_balance : "0"; ?>" 
                                   name="vpr_balance" id="vpr_balance" 
                                   placeholder="Promotioanl Voice Balance" data-parsley-required-message="Please Enter SMS" data-parsley-type="digits" 
                                   required="" data-parsley-type-message="SMS must be a number" data-parsley-min="1"
                                   data-parsley-min-message="SMS must be greater than 0" />
                        </div>
                        <div class="form-group">
                            <label for="vtr_balance">Voice Transactional/Dynamic</label>
                            <input type="text" class="form-control" value="<?php echo (isset($total_vtr_balance) && $total_vtr_balance) ? $total_vtr_balance : "0"; ?>" 
                                   name="vtr_balance" id="vtr_balance" 
                                   placeholder="Transactional Voice Balance" data-parsley-required-message="Please Enter SMS" data-parsley-type="digits" 
                                   required="" data-parsley-type-message="SMS must be a number" data-parsley-min="1"
                                   data-parsley-min-message="SMS must be greater than 0" />
                        </div>
                    </div>
                     ...
                     <div class="col-md-4 padding0">
                        ...
                        <div class="form-group">
                            <label for="vpr_balance">Promotional Credit</label>
                            <input type="text" class="form-control" value="<?php echo (isset($admin_pr_credits) && $admin_pr_credits) ? $admin_pr_credits : "0"; ?>" 
                                   name="pr_credits" id="vpr_balance" 
                                   placeholder="Promotioanl Voice Balance" data-parsley-required-message="Please Enter SMS" data-parsley-type="digits" 
                                   required="" data-parsley-type-message="SMS must be a number" data-parsley-min="1"
                                   data-parsley-min-message="SMS must be greater than 0" />
                        </div>
                          <div class="form-group">
                            <label for="vpr_balance">Premium Credit</label>
                            <input type="text" class="form-control" value="<?php echo (isset($total_prtodnd_credits) && $total_prtodnd_credits) ? $total_prtodnd_credits : "0"; ?>" 
                                   name="prtodnd_credit" id="vpr_balance" 
                                    placeholder="Promotioanl Voice Balance" data-parsley-required-message="Please Enter SMS" data-parsley-type="digits" 
                                   required="" data-parsley-type-message="SMS must be a number" data-parsley-min="1"
                                   data-parsley-min-message="SMS must be greater than 0" />
                        </div>
                          <div class="form-group">
                            <label for="vpr_balance">STOCK Credit</label>
                            <input type="text" class="form-control" value="<?php echo (isset($total_stock_credits) && $total_stock_credits) ? $total_stock_credits : "0"; ?>" 
                                   name="stock_credit" id="vpr_balance" 
                                   placeholder="Promotioanl Voice Balance" data-parsley-required-message="Please Enter SMS" data-parsley-type="digits" 
                                   required="" data-parsley-type-message="SMS must be a number" data-parsley-min="1"
                                   data-parsley-min-message="SMS must be greater than 0" />
                        </div>
                        <div class="form-group">
                            <label for="vtr_balance">Transactional Credit</label>
                            <input type="text" class="form-control" value="<?php echo (isset($admin_tr_credits) && $admin_tr_credits) ? $admin_tr_credits : "0"; ?>" 
                                   name="tr_credits" id="vtr_balance" 
                                   placeholder="Transactional Voice Balance" data-parsley-required-message="Please Enter SMS" data-parsley-type="digits" 
                                   required="" data-parsley-type-message="SMS must be a number" data-parsley-min="1"
                                   data-parsley-min-message="SMS must be greater than 0" />
                        </div>
                    ...
                    <div class="col-md-4 padding0">
                        <label>
                            <strong>Missed Call Alerts</strong>
                        </label>
                        <div class="form-group">
                            <label for="mcall_balance">Virtual Balance</label>
                            <input type="text" class="form-control" value="<?php echo (isset($total_mcall_balance) && $total_mcall_balance) ? $total_mcall_balance : "0"; ?>" 
                                   name="mcall_balance" id="mcall_balance" 
                                   placeholder="Missed Call Alert Balance" data-parsley-required-message="Please Enter Balance" data-parsley-type="digits" 
                                   required="" data-parsley-type-message="Balance must be a number" data-parsley-min="1"
                                   data-parsley-min-message="Balance must be greater than 0" />
                        </div>
                    </div>
                    <div class="col-md-12 padding0">
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary btn-sm" id="btn<?php echo $subtab; ?>1" 
        ...
        <?php } ?>
         ...
         <?php if (isset($subtab) && $subtab == '12') { ?>
        <div class="col-md-12">
            <h4 style="margin-left:21px;">Default Ratio System</h4>
                    </div><br>
      <form role="form" class="setting_forms tab-forms" id="settingForm<?php echo $subtab; ?>1" method='post' action="javascript:saveSetting(<?php echo $subtab; ?>, 1);">
          
          <div class="col-md-2">
            <label>Select Route</label>
            <select name="ratio_type" class="form-control">
            <option >Select Route</option>
            <option value="PR">Promotional</option>
            <option value="TR">Transactional</option>
            <option value="VPR">Promotional Voice</option>
            <option value="VTR">Dynamic Voice</option>
        </select>
            </div><br><br>
          <div class="row"><br><br>
            ...
            <div class="col-md-2">
                    ...
                    <div class="col-md-12">
                        <div class="form-group" style="width: 360px;">
                            ...
                            <div class="input-group">
                                <input type="text" name="fake_delivered_ratio"  placeholder="User Fake Delivered Ratio" class="form-control"
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="fake_fail_ratio"   placeholder="User Fake Failed Ratio" class="form-control"
                                       data-parsley-type-message="Please Enter Valid Percentage" data-parsley-type="integer" data-parsley-range="[0,100]" />
                                <div class="input-group-addon">%</div>
                            </div>
                        </div>
                   ...
                   <div class="col-md-12">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm" id="btn<?php echo $subtab; ?>1" data-loading-text="Processing..." autocomplete="off">Save</button>
                    </div>
            </div>
            </div>
        </form>
                ...
                <div class="row" id="reseller_settings">
                    <div class="col-md-7">
                                ...
                                <div class="input-group">
                                    <label for="pr_sender_id_check" class="fancy-check">
                                        <input type="checkbox" name="pr_sender_id_check" id="pr_sender_id_check"
                                              checked value="1" <?php echo (isset($settings) && isset($settings->pr_sender_id_check) && $settings->pr_sender_id_check) ? "checked" : ""; ?> />
                                        <span>Open</span>
                                    </label>
                                </div>
                            </div>
                                ...
                                <div class="input-group">
                                    <label for="pr_dnd_check" class="fancy-check">
                                        <input type="checkbox" name="pr_dnd_check" id="pr_dnd_check"
                                               value="1" <?php echo (isset($settings) && isset($settings->pr_dnd_check) && $settings->pr_dnd_check) ? "checked" : ""; ?> />
                                        <span>Open</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <select name="sender_id_type" id="sender_id_type" class="form-control">
                                        <option value="" <?php echo isset($settings) && (isset($settings->pr_sender_id_type) && $settings->pr_sender_id_type == '') ? "selected" : ""; ?>>Select Type</option>
                                        <option  value="Numeric" <?php echo (isset($settings) && isset($settings->pr_sender_id_type) && $settings->pr_sender_id_type == 'Numeric') ? "selected" : ""; ?>>Numeric</option>
                                        <option selected="selected" value="Alphabetic" <?php echo (isset($settings) && isset($settings->pr_sender_id_type) && $settings->pr_sender_id_type == 'Alphabetic') ? "selected" : ""; ?>>Alphabetic</option>
                                        <option value="Alphanumeric" <?php echo (isset($settings) && isset($settings->pr_sender_id_type) && $settings->pr_sender_id_type == 'Alphanumeric') ? "selected" : ""; ?>>Alphanumeric</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" name="pr_sender_id_length" value="<?php echo (isset($settings) && isset($settings->pr_sender_id_length)) ? $settings->pr_sender_id_length : 6; ?>" id="pr_sender_id_length" class="form-control"
                                ...
                                <div class="input-group">
                                    <label for="tr_sender_id_check" class="fancy-check">
                                        <input type="checkbox" name="tr_sender_id_check" id="tr_sender_id_check"
                                               value="1" <?php echo (isset($settings) && isset($settings->tr_sender_id_check) && $settings->tr_sender_id_check) ? "checked" : ""; ?> />
                                        <span>Open</span>
                                    </label>
                                </div>
                            </div>
                                ...
                                <div class="input-group">
                                    <label for="tr_keyword_check" class="fancy-check">
                                        <input type="checkbox" name="tr_keyword_check" id="tr_keyword_check"
                                               value="1" <?php echo (isset($settings) && isset($settings->tr_keyword_check) && $settings->tr_keyword_check) ? "checked" : ""; ?> />
                                        <span>Open</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <select name="tr_sender_id_type" id="tr_sender_id_type" class="form-control">
                                        <option value="" <?php echo (isset($settings) && isset($settings->tr_sender_id_type) && $settings->tr_sender_id_type == '') ? "selected" : ""; ?>>Select Type</option>
                                        <option value="Numeric" <?php echo (isset($settings) && isset($settings->tr_sender_id_type) && $settings->tr_sender_id_type == 'Numeric') ? "selected" : ""; ?>>Numeric</option>
                                        <option selected="selected" value="Alphabetic" <?php echo (isset($settings) && isset($settings->tr_sender_id_type) && $settings->tr_sender_id_type == 'Alphabetic') ? "selected" : ""; ?>>Alphabetic</option>
                                        <option value="Alphanumeric" <?php echo (isset($settings) && isset($settings->tr_sender_id_type) && $settings->tr_sender_id_type == 'Alphanumeric') ? "selected" : ""; ?>>Alphanumeric</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <label>Sender Id Length</label>
                                <div class="input-group">
                                    <input type="text" name="tr_sender_id_length" value="<?php echo (isset($settings) && isset($settings->tr_sender_id_length)) ? $settings->tr_sender_id_length : 6; ?>" id="tr_sender_id_length" class="form-control"
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <div class="input-group">
                                    <input type="text" name="sms_limit" value="<?php echo (isset($settings) && isset($settings->sms_limit)) ? $settings->sms_limit : "100"; ?>" class="form-control" id="sms_limit"
                                           data-parsley-error-message="Please Enter Valid Number" data-parsley-type="integer" />
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <button type="submit" class="btn btn-primary btn-sm" id="btn<?php echo $subtab; ?>1" data-loading-text="Processing..." autocomplete="off">Save Setting</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <?php if (isset($subtab) && $subtab == '3') { ?>
            <div class="table-responsive padding15">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody class="bgf7">
                        <?php
                        if (isset($smpp_ports) && $smpp_ports) {
                            $i = 1;
        ...
        <?php if (isset($subtab) && $subtab == '4') { ?>
            ...
            ?>
            <form role="form" class="tab-forms" class="setting_forms" method='post' action="javascript:saveSetting(<?php echo $subtab; ?>, 1);">
                <div class="form-group">
        ...
        <?php if (isset($subtab) && $subtab == '5') { ?>
            <div class="col-md-3 padding15">
                <form role="form" class="setting_forms" id="settingForm<?php echo $subtab; ?>1" method='post' action="javascript:saveSetting(<?php echo $subtab; ?>, 1);">
                    <div class="form-group">
            ...
            <div class="table-responsive padding15">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody class="bgf7">
                        <?php
                        if (isset($white_lists) && $white_lists) {
                            $i = 1;
        ...
        <?php if (isset($subtab) && $subtab == '6') { ?>
            ...
            <div class="table-responsive padding15"><!-- <black list numbers> -->
                <table class="table table-bordered table-striped">
                    ...
                    <tbody class="bgf7">
                        <?php
                        if (isset($black_lists) && $black_lists) {
                            $i = 1;
        ...
        <?php if (isset($subtab) && $subtab == '8') { ?>
            <div class="row" id="reseller_settings">
                ...
                <div class="form-group col-md-4">
                    <h4>Signup Mail</h4>
                    <form role="form" class="setting_forms" method='post' id="settingForm<?php echo $subtab; ?>2" action="javascript:saveSetting(<?php echo $subtab; ?>, 2);">
                        <div class="form-group col-md-12 padding0">
                ...
                <div class="form-group col-md-3">
                    ...
                    <form role="form" class="setting_forms" method='post' id="settingForm<?php echo $subtab; ?>3" action="javascript:saveSetting(<?php echo $subtab; ?>, 3);">
                        <div class="row">
                            <div class="form-group col-md-6">
        ...
        <?php if (isset($subtab) && $subtab == '9') { ?>
            <div class="row" id="reseller_settings">

                <div class="form-group col-md-3">
                    <h4>Forgot Password SMS</h4>
                    <form role="form" class="setting_forms" method='post' id="settingForm<?php echo $subtab; ?>1" action="javascript:saveSetting(<?php echo $subtab; ?>, 1);">
                        <div class="form-group col-md-12 padding0">
        ...
        <?php } ?>
        <?php if (isset($subtab) && $subtab == '11') { ?>
            <div class="row" id="reseller_settings">
                <form role="form" class="setting_forms" method='post' id="settingForm<?php echo $subtab; ?>1" action="javascript:saveSetting(<?php echo $subtab; ?>, 1);">
                    <div class="form-group col-md-3">
                        <h4>Add Alerts</h4>
                        <textarea name="alert" placeholder="Add Content..." class="form-control"></textarea> 

                        <h4>Select User</h4>
                        <select name="a_user" class="form-control" >

                            <option value="0">Select User</option>
                            <?php
                            if (isset($settings) && $settings) {
                                foreach ($settings as $userss) {
                                    ?>
                                    <option value="<?php echo $userss['user_id']; ?>"><?php echo $userss['username'] . "(" . $userss['name'] . ")"; ?></option> 

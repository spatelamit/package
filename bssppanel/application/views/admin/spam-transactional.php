...
//$conn = mysqli_connect("$DBhostname", "$DBusername", "$DBpassword", $DBname) or die(mysql_error());
...
<div id="sp-tss">
    <div  class="container-fluid padding15">
        <div class="row" id="spam_transactional" style="overflow-y: scroll; " >
        ...
        <!--<h5>Status: <?php echo ($sms['black_listed']) ? "Black" : ""; ?></h5>-->
            ...
            <div class="col-lg-8">
                <div style="overflow-y: scroll; " class="list-group"  id="show_user_tr_sms"></div>
            </div>
        </div>
    </div>
</div>

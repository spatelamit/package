    ...
    <div class="tab-pane fade in active">
        ...
        <?php if ($subtab == '2') { ?>
            <div class="row">
                <div class="col-md-4 padding15">
                    <input type="text" id="search_by_number" placeholder="Track Mobile Number" class="form-control" onkeyup="trackMobileNumber(this.value);" />
                </div>
                <div class="col-md-12 padding15">
        ...
        <?php if ($subtab == '3') { ?>
            <div class="row">
                ...
                <div class="col-md-3 padding15 text-right">
                    <button name="search_button" id="search_button" onclick="searchDetailedReport();" class="btn btn-primary">Get Report</button>
                </div>
                <div class="col-md-12 padding15">
        ...
        <?php if ($subtab == '4') { ?>
            <div class="row">
                ...
                <div class="col-md-2 padding15">
                    <button name="get_report_btn" id="get_report_btn" onclick="getDeliveryReport();" class="btn btn-primary">Get Report</button>
                </div>

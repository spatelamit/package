 ...
 */
if ($_SERVER['SERVER_NAME'] == 'sms.bulksmsserviceproviders.com') {
    ...
    <html>
        <head>
            ...
            echo "$timeout; URL=" . base_url() . "admin/monitor";
            ?>">
            <title>Bulk SMS Service Providers: Kannel Status</title>
            <link href="<?php echo base_url(); ?>Assets/admin/css/kannel.css" rel="stylesheet" type="text/css">
            <script src="<?php echo base_url(); ?>Assets/admin/js/kannel.js" type="text/javascript"></script>
        </head>
        <body>
            ...
            <table width=100% cellspacing=0 cellpadding=0 border=0>
                <tr>
                    ...
                    <td valign=top align=right class=text>
                        ...
                        $base_uri = $purl[path];
                        ?>
                        <a class=href href="<?php echo base_url() . "admin/monitor?refresh=" . $t_down; ?>"><?php echo $t_down; ?>s</a> | 
                        <b><?php echo $timeout; ?>s</b> | 
                        <a class=href href="<?php echo base_url() . "admin/monitor?refresh=" . $t_up; ?>"><?php echo $t_up; ?>s</a>
                    </td>
                </tr>
            </table>
    ...
    <table width=100% cellspacing=0 cellpadding=1 border=0>
        <tr>
            ...
            <td valign=top align=right class=text></td>
            <td valign=top class=text>
                Started
            </td>
            <td valign=top class=text>
    ...
    <table width=100% cellspacing=0 cellpadding=1 border=0>
        <tr>
            <td width=10% valign=top class=text>
                Instance
            </td>
            <td valign=top class=text>
                SMSC-ID

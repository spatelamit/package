                ...
                <div class="col-md-6 text-right">
                    <nav>
                        <ul>
                            <?php if ($page_no > 1) { ?>
                                <li class="">
                                    <a href="javascript:void(0);" onclick="paging<?php echo $function; ?>(<?php echo $page_no - 1; ?>, 100, <?php echo $total_pages . ', ' . $subtab; ?>);">
                ...
                <div class="col-md-2 text-right">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <button class="btn btn-primary btn-sm" type="button" onclick="paging<?php echo $function; ?>(page_no.value, 100, <?php echo $total_pages . ', ' . $subtab; ?>);">Go</button>
                        </span>
                    </div>
                </div>
                <?php

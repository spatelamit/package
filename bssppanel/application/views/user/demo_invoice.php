...
<html>
    ...
    <body>
        ...
        <form method="POST" action="<?php echo base_url(); ?>index.php/user/demo_invoice">
            <div class="container">
                ...
                <div class=" wrapper">
                    ...
                    <div class="row">
                        <div class="date">
                            ...
                            ?>
                            <p>Date:<input class="form-control" type="text" id="datepicker" name="date" value="<?php echo $demo_data['date'] ; ?>" placeholder="DD-MM-YYYY"   /></p>
                            <p>Invoice #:<b><input class="form-control" type="text" placeholader="Invoice ID" name="invoice_id" value="<?php echo  $demo_data['invoice_id'] ?>" /></b></p>
                        </div>	
                    </div>
...
Indore 452001, M.P.</textarea></p>
                        ...
                        <div class="col-md-6">
                            <p class="side_to"><b>To:</b> <br><textarea cols="59" rows="5" name="to" ><?php echo  $demo_data['invoice_id'] ?></textarea>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <table width="98%">
                            ...
                            <tr>
                                ...
                                <td align="center"><input type="text"  name="type" value="<?php echo  $demo_data['invoice_id'] ?>" placeholder="SMS Type" ><b>

                                    </b>
                                </td>

                                <td align="center" ><b><input type="text"  name="amount" id="amount" placeholder="Amount" value="<?php echo  $demo_data['invoice_id'] ?>" ></b></td>
                            </tr>
                        </table>
                        <div class="totals">
                        ...
                        <div class="total" id="tax_status" style="display: none;">
                            ...
                            Output Service Tax (14.0%) :<input type="text" id="service_tax" name="service_tax" value="<?php echo  $demo_data['invoice_id'] ?>"><br>
                            Swachh Bharat Cess (0.5%) :	<input type="text" name="swachh_bharat" id="swatchh_bharat" value="<?php echo  $demo_data['invoice_id'] ?>"><br>
                            Krishi Kalyan Cess (0.5%) :	<input type="text" name="krishi_kalyan" id="krishi_kalyan" value="<?php echo  $demo_data['invoice_id'] ?>"><br>
                            <b>Total Amount :	<input type="text" name="total_amount" id="total_amount" value="<?php echo  $demo_data['invoice_id'] ?>"></b>
                        </div>
                    </div>

                    <div class="row">
                        <p class="amt"><b>Amount In Words(With Tax):</b><br>
                            <input style="height: 30px; width: 500px;;" type="input" name="words" id="words" value="<?php echo  $demo_data['invoice_id'] ?>" />
				<br></p>
...
PAN: AAWCS6188C</textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="side_to"> <br><textarea style="height: 175px;" cols="59" rows="5"  > <?php echo  $demo_data['invoice_id'] ?>

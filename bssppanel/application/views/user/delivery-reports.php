                ...
                <div class="portlet-content">
                    <div class="row">
                        <div class="col-md-12 content-header-title tbl">
                            <div class="col-md-5 col-sm-3 col-xs-12 padding0">Text Delivery Report</div>
                            <?php if ($user_id == 9070) {
                                ?>
                            ...
                            <?php } else {
                                ...
                                <div class="col-md-1 col-sm-2 col-xs-12">
                                    ...
                                    <button type="button" name="export_all" id="export_all" class="btn btn-primary" data-loading-text="Processing..." data-toggle="tooltip" title="Report Will Be Send On Your Register Email Address" data-placement="bottom" autocomplete="off" onclick="exportAllReports(<?php echo $user_id; ?>);">Export</button>

                                </div>
                            <?php } ?>
                            <div class="col-md-2 col-sm-3 col-xs-12 pull-right">
                                <div class="input-group um-search">
                                    <input class="form-control" placeholder="Search By Sender Id" id="search" type="text" onkeyup="searchDReports(this.value);" autocomplete="off"> 
                                            ...
                                            <td width="35%" class="word-break">
                                                ...
                                                <a style=" color: royalblue;" title="Click To See Full Delivery Report" href="<?php echo base_url(); ?>user/sent_sms/<?php echo $delivery_report['campaign_id'] . "/" . $delivery_report['route']; ?>">
                                                    ...
                                                    if ($user_info['encription'] == 1) {
                                                        ...
                                                        echo strip_tags(urldecode($delivery_report['message']));
                                                    }
                                                    ?>
                                                </a>
                                            </td>

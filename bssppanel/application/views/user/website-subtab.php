...
<div class="col-md-3 col-sm-4 borderR">
    <div class="row ptb15">
            ...
            <select name="website_domain" id="website_domain" class="form-control" onchange="selectWebsite(this.value);">
                ...
                if (isset($websites) && $websites) {
                    foreach ($websites as $row) {
                        if ($website_id == $row['website_id']) {
                            ?>
                            <option value="<?php echo $row['website_id']; ?>" selected=""><?php echo $row['website_domain']; ?></option>
                            <?php
                        } else {
                            ?>
        ...
        <div class="col-sm-5">
            <input type="button" name="add_new_website" id="add_new_website" value="Add New Website" class="btn btn-success" onclick="selectWebsite('0')" />
        </div>
    </div>
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" id="company_name" name="company_name" required="" placeholder="Enter Company Name"
                               ...
                               value="<?php echo (isset($website) && isset($website->company_name)) ? $website->company_name : ""; ?>" />
                    </div>
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" id="domain_name" name="domain_name" required="" placeholder="Enter Domain Name"
                               ...
                               value="<?php echo (isset($website) && isset($website->website_domain)) ? $website->website_domain : ""; ?>" />
                    </div>
                    <div class="form-group col-md-12">
                        <button type="button" class="btn btn-default btn-xs" onclick="checkDNSSetting();">Check DNS</button>
                    </div>
                    <div class="form-group col-md-12" id="check_dns_msg"></div>
                    <div class="form-group col-md-12">
                        <h5>
                    ...
                    <div class="form-group col-md-12 mt5">
                        <button type="submit" name="save_website" id="save_website" class="btn btn-primary"
                                data-loading-text="Processing..." autocomplete="off">Save Website</button>
                                <?php if (isset($website_id) && $website_id) { ?>
                            <button type="button" name="delete_website" id="delete_website" class="btn btn-danger" data-loading-text="Processing..." autocomplete="off"
                                    onclick="deleteWebsite(<?php echo $website_id; ?>);">Delete Website</button>
                                <?php } ?>
                    </div>
                </div>
            </form>
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-3 col-xs-3 bhoechie-tab-menu">
                                    <div class="list-group">
                                        <a href="#" class="list-group-item active text-center">
                                            <h4><i class="fa fa-leaf"></i></h4> Banner
                                        </a>
                                        <a href="#" class="list-group-item text-center">
                                            <h4><i class="fa fa-magic"></i></h4> Services
                                        </a>
                                        <a href="#" class="list-group-item text-center">
                                            <h4><i class="fa fa-file-text-o"></i></h4> About Us
                                        </a>
                                        <a href="#" class="list-group-item text-center">
                                            <h4><i class="fa fa-comments-o"></i></h4> Contact Us
                                        </a>
                                        <a href="#" class="list-group-item text-center">
                                            <h4><i class="fa fa-share-alt"></i></h4> Social Links
                                        </a>
                                        <a href="#" class="list-group-item text-center">
                                            <h4><i class="fa fa-search"></i></h4> SEO
                                        </a>
                                        <a href="#" class="list-group-item text-center">
                                            <h4><i class="fa fa-th-large"></i></h4> Other
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9 bhoechie-tab">
                                    <div class="portlet" id="show_website_subtab">
                                        ...
                                        <div class="bhoechie-tab-content">
                                            <div id="web-contact">
                                                <form id="contactForm1" action="javascript:saveWebsiteData('contact_us');" method="post" class="tab-forms">
                                                ...
                                                <form id="otherForm" action="javascript:saveWebsiteData('other');" method="post" class="tab-forms">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" name="theme_color" id="theme_color" class="form-control" style="background-color: <?php echo ($website->website_theme_color) ? $website->website_theme_color : ""; ?>"

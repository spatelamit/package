...
<div class="col-md-2 borderR">
    <div class="row content-header-title fhead">
        <div class="col-xs-4 col-md-3">Groups</div>
    </div>
    <div class="row">
            ...
            <div class="col-md-12 col-xs-12">
                <div class="input-group">
                    <input type="text" id="group_name" name="group_name" data-parsley-required-message=""
                           value="" required="" class="form-control input-sm" placeholder="Enter Group Name" />
        ...
        <div class="col-md-12 table-responsive ptb15 data_table" id="show_contact_groups">
...
<div class="col-md-10">
    <div class="row content-header-title fhead">
        <div class="col-xs-6 col-md-3">Contacts</div>

...
class Myaudiolib {
    ...
    // Format Time
    public static function formatTime($duration = null) { //as hh:mm:ss
    ...
    // Calculate Estimate Duration Of Audio File
    ...
    // Calculate Frame Size of Audio File

(function (c) {
    ...
    c.fn.filestyle.defaults = {buttonText: "Choose file", iconName: "fa-folder-open-o", buttonName: "btn-default", size: "nr", input: true, badge: true, icon: true, buttonBefore: false, disabled: false};
